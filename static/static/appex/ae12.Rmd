...
```{r load-flips}
# coin flip data
# coin_flips = data.frame(one_flip = c(rep("H", 20), rep("T", 10)))
# coin_flips$one_flip = sample(coin_flips$one_flip, size = 30, replace = FALSE)
coin_flips = read_csv("~/Desktop/coin_flips.csv")
```
...
p-value of $2 \times 10^{-4}$ < 0.05. We reject the null that the coin is fair.
