...
- A car manufacturer makes 100 vehicles. You count the number of recalls. Let *C* be the event you see fewer than 10 recalls. *C* $= \{1, 2, 3, \ldots, 8, 9 \}$

- You observe the numeric grade you earn in a course. Let *D* be the event you receive a letter grade of "A". *E* $= [93, 100]$. Let *D* be the event that you earn a "B" or worse. *D* and *E* **are disjoint** events.
